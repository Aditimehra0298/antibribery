  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 opacity-60"></div>
        {/* Much lighter gradient overlay for better background visibility */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Warning Badge */}
          <div className="inline-flex items-center space-x-2 bg-red-900/30 border border-red-500/50 rounded-full px-4 py-2 mb-6 animate-pulse hover:animate-bounce transition-all duration-300 hover:scale-105">
            <AlertTriangle className="w-5 h-5 text-red-400" />
